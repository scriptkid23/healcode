...
class AISuggestionService:
    """
    AI Service for processing error messages, searching relevant files, loading context, and suggesting edits.
    """
    ...
    async def process_error_message(self, error_message: str) -> Dict[str, Any]:
        ...
        """
        # 1. Parse error message (extract file and line if present)
        import re
