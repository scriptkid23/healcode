...
from ..core.interfaces import IIndexer, IEventBus, IStateful, IHealthCheckable, EventType


class TrigramIndexer(IStateful, IHealthCheckable):
    """
    ...
    def __init__(self, config: Dict[str, Any], event_bus: Optional[IEventBus] = None):
        self.config = config
