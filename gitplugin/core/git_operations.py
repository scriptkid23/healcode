...
class GitOperationsEngine:
    ...
    async def setup_repository(
        self, repo_url: str, credential: Dict[str, str], workspace_path: str
    ) -> str:
    ...
    def _clone_repository(self, auth_url: str, workspace_path: Path) -> Repo:
        ...
        try:
            ...
            if (
                ...
                raise ValueError(
                    "Permission denied. Please check your access permissions."
                )
    ...
    async def pull_changes(
        self, workspace_path: str, credential: Dict[str, str] = None
    ) -> Dict[str, Any]:
    ...
    async def commit_changes(
        self, workspace_path: str, message: str, files: Optional[List[str]] = None
    ) -> Dict[str, Any]:
    ...
    async def push_changes(
        self, workspace_path: str, branch: str = None
    ) -> Dict[str, Any]:
    ...
    async def create_branch(
        self, workspace_path: str, branch_name: str, checkout: bool = True
    ) -> Dict[str, Any]:
        """Create new branch"""
        try:
            repo = self._get_repository(workspace_path)
    ...
    def _prepare_auth_url(self, repo_url: str, credential: Dict[str, str]) -> str:
        ...
        try:
            ...
            self.logger.warning(
                f"Unsupported credential type: {credential.get('type')}"
            )
            return repo_url
    ...
    async def _create_github_pr(
        ...
        try:
            ...
            payload = {
                ...
                "base": target_branch,
                "body": description
                or f"Automated pull request from {source_branch} to {target_branch}",
            }
    ...
    async def _create_gitlab_pr(
        ...
        try:
            ...
            project_path = repo_url.replace("https://gitlab.com/", "").replace(
                ".git", ""
            )
            ...
            payload = {
                ...
                or f"Automated merge request from {source_branch} to {target_branch}",
            }
